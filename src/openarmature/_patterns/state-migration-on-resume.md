...
- Migrations need to call the LLM or do other slow / fallible work.
  ...
  [bypass-if-output-exists](https://openarmature.ai/patterns/bypass-if-output-exists/), not in a
  migration callable.
...
- [`session-as-checkpoint-resume`](https://openarmature.ai/patterns/session-as-checkpoint-resume/):

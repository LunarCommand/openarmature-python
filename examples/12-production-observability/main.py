...
Complementary to example 03 (observer hooks with three observers
side-by-side) and example 10 (Langfuse observer + LangfusePromptBackend
prompt linkage).  This example's headline is the production-shape
wiring, not the hook surface or the prompt linkage.
...
def build_graph():
    ...
    in examples 05 / 06; this one's scope is observability)."""
